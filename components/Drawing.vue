<template>
  <div
    class="w-full lg:max-w-5xl mx-auto flex flex-col flex-1 mt-8 md:mt-20 lg:pl-24 lg:pr-40 lg:mt-9"
  >
    <textarea
      v-model="participantsInput"
      aria-label="Add a comma-separated list of participants ..."
      class="w-full flex-1 block p-4 md:p-6 font-medium text-blue-500 placeholder-blue-500 bg-teal-100 border-3 border-blue-500 shadow-blue rounded-md focus:outline-none focus:shadow-outline-pink transition ease-in-out duration-150"
      placeholder="Add a comma-separated list of participants ..."
    />
    <div class="mt-8 md:mt-12 flex flex-row items-center justify-between">
      <p class="text-xl md:text-2xl leading-tight font-bold text-purple-800">
        Number of winners
      </p>
      <div class="flex items-center justify-between">
        ...
        <span
          class="mx-4 w-8 inline-flex justify-center text-xl md:text-2xl font-bold text-purple-800"
          >{{ numberOfWinners }}</span
        >
        <button
    ...
    <div class="mt-8 md:mt-12">
      <button
        ...
        "
        type="button"
        class="w-full inline-flex items-center justify-center p-4 md:p-6 border-3 border-purple-800 text-xl md:text-2xl leading-tight font-bold rounded-md shadow-purple-lg text-purple-800 bg-pink-500 focus:outline-none focus:shadow-outline-pink hover:translate-x-6px hover:translate-y-6px focus:translate-x-6px focus:translate-y-6px hover:shadow-none focus:shadow-none transform transition ease-in-out duration-150"
        @click="pickWinners"
      >
